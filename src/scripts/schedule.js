...
var list = angular.element(element.getElementById("schedule"));
var track1Checkbox = angular.element(element.getElementById(".show-track-1"));
var track2Checkbox = angular.element(element.getElementById(".show-track-2"));
...
function displaySchedule() {
    ...
    for (var i = 0; i < schedule.length; i++) {
        var track = schedule[i].tracks;
        var isCurrentTrack = (track1Checkbox.checked && track.indexOf (1) >=0) ||
        (track2Checkbox.checked && track.indexOf(2) >=0);
            if (isCurrentTrack){
